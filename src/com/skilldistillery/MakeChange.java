...
public class MakeChange {
	...
	private String userChangeStringBuilder(String currentString, int typeOfCurrency, String billType,
		...
		if (typeOfCurrency > 1) {
			...
			if (billType.contains("quarter") || billType.contains("dime") || billType.contains("nickel")
					|| billType.contains("penny")) {

				currentString += " " + typeOfCurrency + " " + billPlural;
				return currentString;
			} else {

				currentString += " " + typeOfCurrency + " " + billType + " " + billPlural;
				return currentString;
			}

		} else if (typeOfCurrency > 0) {

			currentString += " " + typeOfCurrency + " " + billType + billSingular;
			return currentString;
		} else {
